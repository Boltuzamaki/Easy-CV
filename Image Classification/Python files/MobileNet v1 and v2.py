...
depth_multiplier_n = 1
dropout_num_n = 1e-3                                       # Resolution multiplier
alpha_n = 0.75                                            # width multiplier
...
def Mobile_Net(trainable=None, net = "MobileNet"):
    ...
    if net == "MobileNet":
        mobilenet = MobileNet(include_top=False,alpha = alpha_n,depth_multiplier = depth_multiplier_n,dropout = dropout_num_n, weights='imagenet', input_shape=input_sh,pooling = pooling_model)
    if net == "MobileNetV2":
        mobilenet = MobileNetV2(include_top=False,alpha = alpha_n, weights='imagenet', input_shape=input_sh,pooling = pooling_model)
...
# #### Mobile_Net  --> Only for Top layer addition not for fine tuning
# #### Mobile_Net(trainable = 70, net = "MobileNet")  -->For fine tuning (Means all layer after 70 is trainable)
# #### change any model you want from list ['MobileNet','MobileNetV2']

# In[ ]:


Mobile_Net(net = 'MobileNet',trainable = 70)
